...
public class EMBOSS_diffseqEditors extends javax.swing.JDialog implements EditorInterface  {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(EMBOSS_diffseqEditors2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(EMBOSS_diffseqEditors2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        how_jButton.getAccessibleContext().setAccessibleDescription("Find differences between nearly identical sequences");
    ...
    *******************************************************************/
    ...
    private void enabledFunctionForStandard_qualifiers(boolean e) {
        this.Sq_wordsize_Box.setEnabled(e);
        if (properties.isSet(Sq_wordsize_Box.getName()) && e==true) {
            this.Sq_wordsize_Box_IntValue.setEnabled(true);
        } else {
            this.Sq_wordsize_Box_IntValue.setEnabled(false);
        }

        this.Sq_globaldifferences_Box.setEnabled(e);
        if (properties.isSet(Sq_globaldifferences_Box.getName()) && e==true) {
            this.Sq_globaldifferences_Box_IntValue.setEnabled(true);
        } else {
            this.Sq_globaldifferences_Box_IntValue.setEnabled(false);
        }
    ...
    *******************************************************************/
    ...
    private void usp_valueANDtext (workflow_properties properties) {
        if (properties.isSet(Sq_wordsize_Box_IntValue.getName())){
            this.Sq_wordsize_Box_IntValue.setValue(Integer.parseInt(properties.get(Sq_wordsize_Box_IntValue.getName())));
            this.Sq_wordsize_Box_IntValue.setEnabled(false);
        }
        if (properties.isSet(Sq_globaldifferences_Box_IntValue.getName())){
            this.Sq_globaldifferences_Box_IntValue.setValue(Integer.parseInt(properties.get(Sq_globaldifferences_Box_IntValue.getName())));
            this.Sq_globaldifferences_Box_IntValue.setEnabled(false);
        }
    }
    
    private void usp_boxANDbutton (workflow_properties properties) {
        if (properties.isSet(Sq_wordsize_Box.getName())){
            this.Sq_wordsize_Box.setSelected(true);
            this.Sq_wordsize_Box_IntValue.setEnabled(true);
        }
        if (properties.isSet(Sq_globaldifferences_Box.getName())){
            this.Sq_globaldifferences_Box.setSelected(true);
            this.Sq_globaldifferences_Box_IntValue.setEnabled(true);
        }
    }
