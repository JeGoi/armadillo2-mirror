...
public class EMBOSS_chipsEditors extends javax.swing.JDialog implements EditorInterface  {
    ...
    private void initComponents() {
        ...
        Sq_panelLayout.setHorizontalGroup(
            ...
            .addGroup(Sq_panelLayout.createSequentialGroup()
                ...
                .addGroup(Sq_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Sq_nosum_Box)                    .addComponent(Sq_sum_Box))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(EMBOSS_chipsEditors2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(EMBOSS_chipsEditors2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        how_jButton.getAccessibleContext().setAccessibleDescription("Codon usage statistics Nucleotide sequence(s) filename and optional format, or reference (input USA)");
    ...
    *******************************************************************/
    ...
    private void enabledFunctionForStandard_qualifiers(boolean e) {
        this.Sq_nosum_Box.setEnabled(e);
        this.Sq_sum_Box.setEnabled(e);
    }
    ...
    *******************************************************************/
    ...
    private void usp_boxANDbutton (workflow_properties properties) {
        if (properties.isSet(Sq_nosum_Box.getName())){
            this.Sq_nosum_Box.setSelected(true);
        }
        if (properties.isSet(Sq_sum_Box.getName())){
            this.Sq_sum_Box.setSelected(true);
        }
    }
