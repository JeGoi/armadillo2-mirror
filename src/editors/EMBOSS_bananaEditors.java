...
public class EMBOSS_bananaEditors extends javax.swing.JDialog implements EditorInterface  {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(EMBOSS_bananaEditors2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(EMBOSS_bananaEditors2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        how_jButton.getAccessibleContext().setAccessibleDescription("Bending and curvature plot in B-DNA");
    ...
    *******************************************************************/
    ...
    private void enabledFunctionForStandard_qualifiers(boolean e) {
        this.Sq_graph_Box.setEnabled(e);
        if (properties.isSet(Sq_graph_Box.getName()) && e==true) {
            this.Sq_graph_Box_List.setEnabled(true);
        } else {
            this.Sq_graph_Box_List.setEnabled(false);
        }

        this.Sq_residuesperline_Box.setEnabled(e);
        if (properties.isSet(Sq_residuesperline_Box.getName()) && e==true) {
            this.Sq_residuesperline_Box_IntValue.setEnabled(true);
        } else {
            this.Sq_residuesperline_Box_IntValue.setEnabled(false);
        }
    ...
    *******************************************************************/
    ...
    private void usp_valueANDtext (workflow_properties properties) {
        if (properties.isSet(Sq_residuesperline_Box_IntValue.getName())){
            this.Sq_residuesperline_Box_IntValue.setValue(Integer.parseInt(properties.get(Sq_residuesperline_Box_IntValue.getName())));
            this.Sq_residuesperline_Box_IntValue.setEnabled(false);
        }
        if (properties.isSet(Sq_graph_Box_List.getName())){
            this.Sq_graph_Box_List.setSelectedItem(properties.get(Sq_graph_Box_List.getName()));
            this.Sq_graph_Box_List.setEnabled(false);
        }
    }
    
    private void usp_boxANDbutton (workflow_properties properties) {
        if (properties.isSet(Sq_graph_Box.getName())){
            this.Sq_graph_Box.setSelected(true);
            this.Sq_graph_Box_List.setEnabled(true);
        }
        if (properties.isSet(Sq_residuesperline_Box.getName())){
            this.Sq_residuesperline_Box.setSelected(true);
            this.Sq_residuesperline_Box_IntValue.setEnabled(true);
        }
    }
