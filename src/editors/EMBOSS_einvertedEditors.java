...
public class EMBOSS_einvertedEditors extends javax.swing.JDialog implements EditorInterface  {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(EMBOSS_einvertedEditors2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(EMBOSS_einvertedEditors2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    *******************************************************************/
    ...
    private void enabledFunctionForStandard_qualifiers(boolean e) {
        this.Sq_gap_Box.setEnabled(e);
        if (properties.isSet(Sq_gap_Box.getName()) && e==true) {
            this.Sq_gap_Box_IntValue.setEnabled(true);
        } else {
            this.Sq_gap_Box_IntValue.setEnabled(false);
        }

        this.Sq_threshold_Box.setEnabled(e);
        if (properties.isSet(Sq_threshold_Box.getName()) && e==true) {
            this.Sq_threshold_Box_IntValue.setEnabled(true);
        } else {
            this.Sq_threshold_Box_IntValue.setEnabled(false);
        }
        ...
        this.Sq_maxrepeat_Box.setEnabled(e);
        if (properties.isSet(Sq_maxrepeat_Box.getName()) && e==true) {
            this.Sq_maxrepeat_Box_IntValue.setEnabled(true);
        } else {
            this.Sq_maxrepeat_Box_IntValue.setEnabled(false);
        }
    ...
    *******************************************************************/
    ...
    private void usp_valueANDtext (workflow_properties properties) {
        if (properties.isSet(Sq_gap_Box_IntValue.getName())){
            this.Sq_gap_Box_IntValue.setValue(Integer.parseInt(properties.get(Sq_gap_Box_IntValue.getName())));
            this.Sq_gap_Box_IntValue.setEnabled(false);
        }
        if (properties.isSet(Sq_threshold_Box_IntValue.getName())){
            this.Sq_threshold_Box_IntValue.setValue(Integer.parseInt(properties.get(Sq_threshold_Box_IntValue.getName())));
            this.Sq_threshold_Box_IntValue.setEnabled(false);
        }
        ...
        if (properties.isSet(Sq_maxrepeat_Box_IntValue.getName())){
            this.Sq_maxrepeat_Box_IntValue.setValue(Integer.parseInt(properties.get(Sq_maxrepeat_Box_IntValue.getName())));
            this.Sq_maxrepeat_Box_IntValue.setEnabled(false);
        }
    }
    
    private void usp_boxANDbutton (workflow_properties properties) {
        if (properties.isSet(Sq_gap_Box.getName())){
            this.Sq_gap_Box.setSelected(true);
            this.Sq_gap_Box_IntValue.setEnabled(true);
        }
        if (properties.isSet(Sq_threshold_Box.getName())){
            this.Sq_threshold_Box.setSelected(true);
            this.Sq_threshold_Box_IntValue.setEnabled(true);
        }
        ...
        if (properties.isSet(Sq_maxrepeat_Box.getName())){
            this.Sq_maxrepeat_Box.setSelected(true);
            this.Sq_maxrepeat_Box_IntValue.setEnabled(true);
        }
    }
