...
public class EMBOSS_banana extends RunProgram {
    ...
    private String doPgrmPath     = "banana --auto";
    private String doSharedFolder = "/data";
    private String doName         = "emboss_EMBOSS_banana_armadilloWF_0";
    //INPUTS
    ...
    //PATHS
    private static final String outputPath = "."+File.separator+"results"+File.separator+"EMBOSS"+File.separator+"banana"+File.separator+"";
    ...
    public String[] init_createCommandLine() {
        ...
        //Create ouputs
        output1 = outputPath+File.separator+"OutpuOf_"+input1+".profile";
        outputInDo1 = doSharedFolder+File.separator+"OutpuOf_"+input1+".profile";
    ...
    */
    ...
    public void post_parseOutput() {
        ...
        BananaFile.saveBananaFile(properties,output1,"EMBOSS_banana");
