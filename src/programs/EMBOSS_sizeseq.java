...
public class EMBOSS_sizeseq extends RunProgram {
    ...
    private String doPgrmPath     = "sizeseq --auto";
    private String doSharedFolder = "/data";
    private String doName         = "emboss_EMBOSS_sizeseq_armadilloWF_0";
    //INPUTS
    ...
    //PATHS
    private static final String outputPath = "."+File.separator+"results"+File.separator+"sizeseq"+File.separator+"";
    ...
    public String[] init_createCommandLine() {
        ...
        //Create ouputs
        output1 = outputPath+File.separator+"OutpuOf_"+input1+".fasta";
        outputInDo1 = doSharedFolder+File.separator+"OutpuOf_"+input1+".fasta";
        ...
        com[4]=options;
        com[5]= "-sequences "+inputInDo1;
        com[6]= "-outseq "+outputInDo1;
        return com;
    }
