...
////////////////////////////////////////////////////////////////////////////////
///
/// Create a Thread to run  mirnatools
///
/// Etienne Lord 2010
...
public class ShrimpToFasta extends RunProgram {
    
    
    ////////////////////////////////////////////////////////////////////////////
    /// Input / Output
    
    public ShrimpToFasta(workflow_properties properties) {
        super(properties);
        execute();
    }
    ...
    public boolean init_checkRequirements() {
        int fastafile_id=properties.getInputID("TextFile");
        if (fastafile_id==0) {
            setStatus(this.status_BadRequirements,"No SHRIMP output file found in input");
            return false;
        }
        return true;
    }
